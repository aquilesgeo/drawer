...
<div id="panelContainer" style="position:absolute;width:1200px;height:800px;background:#c0c0c0;overflow:hidden;padding:0px;margin:0px">
	...
	<div id="panelEvent" style="position:absolute;top:0px;left:0px;width:100%;height:100%" onmousedown="mouseDown(event)" onmouseup="mouseUp(event)" onmousemove="mouseMove(event)">
